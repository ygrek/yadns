...
(* OASIS_START *)
(* DO NOT EDIT (digest: 07f83b7136420eb029c14f13cdce43b0) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Dns_format"; "Dns_utils"; "Dns_logic"];
                      lib_pack = false;
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "src/";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "yadns"];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "camlp4"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {exec_custom = false; exec_main_is = "dns_client.ml"; });
               Executable
                 ({
                     cs_name = "test";
                     cs_data = PropList.Data.create ();
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "API reference for yadns";
                      doc_authors = ["ygrek"];
                      doc_abstract = None;
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\136\136\255\003\t\143Rd\23394\027\003)?\213";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
